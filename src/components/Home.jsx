...
const Home = () => {
  return (
    <div name="home" className="h-full w-full bg-[#0C2D48]/80" id="home">
      <div className="col-span-1 sm:hidden">
        <img
          src={supakrit}
          alt="supakrit's photo"
          className="mx-auto w-[50%] rounded-lg pt-24"
        />
      </div>
      <div className="sm:first-line container mx-auto h-full max-w-[1000px] gap-5 px-8 pt-5 sm:grid sm:grid-cols-3 sm:items-center sm:justify-center">
